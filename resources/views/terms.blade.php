...
<div class="row">
    ...
    <div class="col-6">
        <h1>Terms</h1>
        <div> Es un hecho establecido hace demasiado tiempo que un lector se
            ...
            en estado de desarrollo. Muchas versiones han evolucionado a través de los años, algunas
            veces por accidente, otras veces a propósito (por ejemplo insertándole humor y cosas por
            el estilo). </div>
    </div>
    <div class="col-3">
